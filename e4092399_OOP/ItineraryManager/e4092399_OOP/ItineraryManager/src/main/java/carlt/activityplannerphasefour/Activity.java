...
public class Activity {
    ...
    /**
     * getActivityAddOnsList() method
     *
     * @return list of activity add-ons.
     *
     */
    public List<AddOn> getActivityAddOnsList() {
     ...
     /**
     * getItineraryAddOnsList() method
     *
     * @return list of itinerary add-ons.
     *
     */
    ...
    /**
     * addActivityAddOn() method - adds an activity AddOn object to the activity addOnsList.
     *
     * @param addOn
     */
    ...
    public void addActivityAddOn(AddOn addOn) {
     ...
     /**
     * addItineraryAddOn() method - adds an itinerary AddOn object to the
     * itinerary addOnsList.
     *
     * @param addOn
     */
    ...
    public String setActivityTitleFromCode(List<String> activityCodesList, int index) {
        ...
        activityTitle = switch (activityCode) {
            case "ACT-01" -> "Building a bridge from paper";
            case "ACT-02" -> "Cookery Classes";
            case "ACT-03" -> "SAS-Style Assault Courses";
            case "ACT-04" -> "Obstacle Course";
            case "ACT-05" -> "Cavern Ziplining";
            default -> null;
        };
        return activityTitle;
    ...
    public String activityBaseCostOutput(String activityTitle) {
        ...
        switch (activityTitle) {
            ...
            case "Cookery Classes" -> {
                ...
                double baseActivityCostInPounds2 = (baseActivityCost / 100);
                return String.format("Cookery Classes: £%.2f ", baseActivityCostInPounds2);
            }
            case "SAS-Style Assault Courses" -> {
                baseActivityCost = 15000.0;
                double baseActivityCostInPounds3 = (baseActivityCost / 100);
                return String.format("SAS-Style Assault Courses: £%.2f ", baseActivityCostInPounds3);
            }
            case "Obstacle Course" -> {
                baseActivityCost = 9000.0;
                double baseActivityCostInPounds4 = (baseActivityCost / 100);
                return String.format("Obstacle Course: £%.2f ", baseActivityCostInPounds4);
            }
            case "Cavern Ziplining" -> {
                baseActivityCost = 17500.0;
                double baseActivityCostInPounds5 = (baseActivityCost / 100);
                return String.format("Cavern Ziplining: £%.2f ", baseActivityCostInPounds5);
            }
            default -> {
                baseActivityCost = 0;
    ...
    public double setActivityBaseCostByCode(List<String> activityCodesList) {
        ...
        for (String activityCode : activityCodesList) {
            switch (activityCode) {
                case "ACT-01" -> totalBaseActivityCost += 2500.0;
                case "ACT-02" -> totalBaseActivityCost += 7500.0;
                case "ACT-03" -> totalBaseActivityCost += 15000.0;
                case "ACT-04" -> totalBaseActivityCost += 9000.0;
                case "ACT-05" -> totalBaseActivityCost += 17500.0;
                default -> totalBaseActivityCost += 0.0;
            }
        }
    ...
    public String setActivityCode() {
        ...
        code = switch (title) {
            case "Building a bridge from paper" -> "ACT-01";
            case "Cookery Classes" -> "ACT-02";
            case "SAS-Style Assault Courses" -> "ACT-03";
            case "Obstacle Course" -> "ACT-04";
            case "Cavern Ziplining" -> "ACT-05";
            default -> "ERR-ACT";
        };
        return code;
    }
