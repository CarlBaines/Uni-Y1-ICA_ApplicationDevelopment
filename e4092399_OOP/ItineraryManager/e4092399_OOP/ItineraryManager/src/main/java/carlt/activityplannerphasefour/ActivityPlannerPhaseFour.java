...
public class ActivityPlannerPhaseFour {
    ...
    /**
     *
     * initialiseActivityAddOns() method
     *
     * @return an activity add-ons list populated with a new activity AddOn object.
     *
     */
    ...
    /**
     *
     * initaliseItineraryAddOns() method
     *
     * @return an itinerary addOnsList populated with a new itinerary AddOn object.
     *
     */
        ...
        try (Scanner in = new Scanner(System.in)) {
            ...
            do {
                ...
                switch (choice.toLowerCase()) {
                    ...
                    default -> {
                        System.out.println("ERROR! A load, save or view option was not selected!\nEnter a valid option: ");
                    }
                }
            } while (!choice.equalsIgnoreCase("load") && !choice.equalsIgnoreCase("save") && !choice.equalsIgnoreCase("view"));
        }
    ...
    public static void inputItineraryDetails(String choice) {
        ...
        // Handles and collects itinerary add-ons from the user.
        String finalItineraryAddOns = Validation.validateItineraryAddOnInput(itineraryAddOnCodesList, newAddOn);
        
        // The finalItineraryAddOns string is converted to an arraylist.
        ...
        for (String itineraryAddOn : selectedItineraryAddOns) {
            // Splits each addOn within the arraylist by spaces.
        ...
        newItinerary.setNumberOfActivities(finalTotalActivities, activities);
        // Calculate the final itinerary cost by passing the user-inputted itinerary details to the totalItineraryCost method.
        ...
        // loops through the activityAddOns map to get the key and value at each index.
        ...
        // The elements from the finalActivityAddOnsList are joined together, trimmed of whitespace and seperated by commas.
    ...
    public static void loadExistingItinerarySummary(Activity newActivity, List<Activity> activities, List<String> activityCodesList, List<AddOn> activityAddOnsList, List<AddOn> itineraryAddOnsList, Itinerary newItinerary, Output newOutput, AddOn newAddOn) {
        ...
        // GENERATES ITINERARY ADD-ON NAME, PRICE OF ITINERARY ADD-ON, THE NUMBER OF ATTENDEES, THE TOTAL ITINERARY ADD-ON COST
        ...
        // Method call to construct the pipe borders for the itinerary summary output.
     ...
     *
     * 
     * constructLines() method - Constructs the pipe borders for the itinerary summary output and
     * populates the formatted table with the contents of the lines ArrayList.
     *
     * 
     * @param lines
     */
    ...
    public static void constructLines(List<String> lines) {
        ...
        // Set to -1 since an int can't be null.
        int longest = -1;
        
        // Loops through the lines list.
        for (String s : lines) {
            // If longest is equal to -1 or the length of the current line in the lines list is smaller or equal to the longest integer.
            if (longest == -1 || s.length() >= longest) {
                // Sets the longest integer to the length of the current line.
                longest = s.length();
            }
        }
    ...
    public static void inputAnotherItinerary() {
        // new file object with pathname of the itineraries file.
    ...
    public static String totalItineraryCost(Itinerary newItinerary, List<Activity> activities, List<String> processedItineraryAddOns) {
        ...
        for (Activity activity : activities) {
            ...
            // Adds the cost of every add-on code that is selected from the user input phase.
        ...
        if (processedItineraryAddOns != null){
            // Loops through the list of user-inputted itinerary add-ons
            for (String itineraryAddOn : processedItineraryAddOns){
