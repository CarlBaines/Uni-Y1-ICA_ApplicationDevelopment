...
public class Output {
    ...
    public int generateAddOnsQuantity(List<String> addOnsList){
    ...
    public double generateTotalAddOnCost(AddOn newAddOn, List<String> addOnsList){
        return generateBaseAddOnCost(newAddOn) * generateAddOnsQuantity(addOnsList);
    }
    
    public double generateAddOnSubtotal(AddOn newAddOn){
        return newAddOn.setAddOnCostAndType();
    }
