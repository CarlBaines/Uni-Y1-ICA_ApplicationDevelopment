...
public class Itinerary {
    ...
    public Itinerary(String referenceNumber, String nameOfLeadAttendee, Activity activityList, double itineraryBaseCost, double discountPercentage, double itineraryCostWithDiscount, int numOfActivities, int numOfAttendees) {
    ...
    /**
     * addActivity() method
     * Method that adds new objects of type activity to the activityList.
     * 
     */
    ...
    /**
     * setItineraryReferenceNumber() method
     * Method that sets and returns the itinerary reference number by performing validation.
     * 
     * @param refNumInput
    ...
    public String setItineraryReferenceNumber(String refNumInput){
        ...
        for (int index = 0; index < reftoArray.length; index++){
            ...
            else if(!Character.isLetter(reftoArray[0]) || !Character.isUpperCase(reftoArray[0])){
    ...
    /**
     * setLeadAttendee() method
     * Method that sets and returns the lead attendee name by performing validation.
     * 
    ...
    /**
     * setNumberOfActivities() method
     * Method that sets the number of activities for an itinerary object.
     * 
     * @param activities
     */
    ...
    /**
     * setTotalActivityCost() method
     * Method that sets and returns the total activity cost 
     * 
    ...
    public double setItineraryBaseCost(){
     ...
     /**
     * setItineraryBaseCostWithAddOns() method
     * Method that sets and returns the total itinerary cost with the price of add-ons included.
     * 
     * @return totalCost
     */
    ...
    public void setItineraryDiscountPercentage(){
        ...
        itineraryBaseCost = this.itineraryBaseCost;
        discountPercentage = 0;
        
        numOfActivities = this.numOfActivities;
    ...
    public String toString(){
        ...
        return "Itinerary Reference Number: {" + referenceNumber + "}" + ", Name of Lead Attendee: {" + nameOfLeadAttendee + "}" + ", Number of activities: {" + getNumOfActivities() + "}" + ", Number of attendees: {" + numOfAttendees + "}";
    }
}
